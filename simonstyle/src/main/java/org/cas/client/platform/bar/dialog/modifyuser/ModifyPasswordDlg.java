...
public class ModifyPasswordDlg  extends JDialog implements ICASDialog, ActionListener, WindowListener, ComponentListener{
	
	/** Creates a new instance of ContactDialog
	 * @called by PasteAction 为Copy邮件到联系人应用。
	 */
	public ModifyPasswordDlg(JFrame pParent, String pUserName){
		super(pParent, true);
		userName = pUserName;
		initDialog();
	}
	 ...
	 * Window, or the first Frame or Dialog that is an owner of the focused Window.
	 */
	...
	private void initDialog(){
		...
		//初始化－－－－－－－－－－－－－－－－
		general = new ModifyPasswordGneeralPanel();
...
//		ok.setFont(CustOpts.custOps.getFontOfDefault());
	...
	static String userName;		// 标志对话框是否已关闭
	private JButton ok;
	private JButton cancel;
	private ModifyPasswordGneeralPanel general;
}
