...
public class DeleteUserDlg  extends JDialog implements ICASDialog, ActionListener, ComponentListener{
	/** Creates a new instance of ContactDialog
	 * @called by PasteAction 为Copy邮件到联系人应用。
	 */
	public DeleteUserDlg(JFrame pParent){
		super(pParent, true);
		initDialog();
	}
	...
	private void initDialog(){
		setTitle(LoginDlgConst.DeleteUserTitle);
		setResizable(false);
		
		//初始化－－－－－－－－－－－－－－－－
		general = new DeleteUserGeneralPanel();
...
//		ok.setFont(CustOpts.custOps.getFontOfDefault());
	...
	private DeleteUserGeneralPanel general;
}
