...
public class CASBathBar extends JPanel implements ComponentListener, ActionListener {
    ...
    private void init() {
        ...
        lblMoneyInLabel = new JLabel(MagicbathDlgConst.MoneyIn);
        lblMoneyOutLabel = new JLabel(MagicbathDlgConst.MoneyOut);
        lblMoneyLeftLabel = new JLabel(MagicbathDlgConst.MoneyLeft);
        lblMoneyEarnLabel = new JLabel(MagicbathDlgConst.MoneyEarn);
        lblMoneyUnit = new JLabel(MagicbathDlgConst.MoneyUnit);
        lblMoneyIn = new JLabel();
        lblMoneyOut = new JLabel();
        lblMoneyLeft = new JLabel();
        lblMoneyEarn = new JLabel();
        btnOK = new JButton(MagicbathDlgConst.CheckOut);
