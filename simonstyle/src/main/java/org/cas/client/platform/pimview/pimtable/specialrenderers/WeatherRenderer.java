...
public class WeatherRenderer extends DefaultPIMTableCellRenderer
{
    ...
    boolean isSelected, boolean hasFocus, int row, int column)
    {
        ...
        {
            setIcon(CustOpts.custOps.getWeatherIcon(0));
        }
        else
        {
            int imgID = Integer.parseInt(value.toString());
            setIcon(CustOpts.custOps.getWeatherIcon(imgID));
        }
        return this;
    }
