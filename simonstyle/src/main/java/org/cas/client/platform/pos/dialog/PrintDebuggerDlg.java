...
public class PrintDebuggerDlg extends JDialog implements ICASDialog, ActionListener, ComponentListener, KeyListener {
    ...
    private void initDialog() {
        // 初始化－－－－－－－－－－－－－－－－
        lblCommand = new JLabel(PosDlgConst.PrintCommand);
        ...
        lblParameters = new JLabel(PosDlgConst.parameters);
        btnAdd = new JButton(PosDlgConst.Add);
        btnDelete = new JButton(DlgConst.DELETE);
        btnExcute = new JButton(PosDlgConst.Test);
        btnClose = new JButton(DlgConst.FINISH_BUTTON);

        // properties
        setTitle(PosDlgConst.PrintDebugger);
    ...
    private char getCharPara(
        ...
        if (tSt.length() == 0) {
            JOptionPane.showMessageDialog(this, PosDlgConst.MsgMissPara);
            return '郝';
        } else
            return tSt.charAt(0);
    }
	...
	public void actionPerformed(
        ...
        if (o == btnExcute) {
            ...
            tVec.add(PosDlgConst.commandTips[tSeleIdx]);
            switch (tSeleIdx) {
                case 0:
	...
	public void keyPressed(
        ...
        if (e.getKeyCode() == 112) {
            ...
            tTextPane.setText(PosDlgConst.commandTips[cmbCommand.getSelectedIndex()]);
    ...
    private String[] commandAry = PosDlgConst.CommandAry;

    private String[] header = new String[] { PosDlgConst.PrintCommand, PosDlgConst.Note, "A", "B", "C", "D", "E", "F",
            "G", "H", "I", "J" };
}
