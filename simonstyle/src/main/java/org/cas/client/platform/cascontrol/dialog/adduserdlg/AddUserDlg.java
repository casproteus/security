...
public class AddUserDlg extends JDialog implements ICASDialog, ActionListener, WindowListener, ComponentListener {

    public static void main(
            String[] args) {
        new AddUserDlg(null).show();
    }
     ...
     *            弹出对话框的Frame
     */
    public AddUserDlg(Frame parent) {
        super(parent, false);
    ...
    public void reLayout() {
        ...
        general.setBounds(CustOpts.HOR_GAP, CustOpts.VER_GAP, getContainer().getWidth() - 2 * CustOpts.HOR_GAP,
                (cancel.getY()) - 2 * CustOpts.VER_GAP);
    ...
    private void initDialog() {
        setTitle(AddUserDlgConst.AddUser);

        setBounds((CustOpts.SCRWIDTH - 260) / 2, (CustOpts.SCRHEIGHT - 160) / 2, 260, 160); // 对话框的默认尺寸。
    ...
    private AddUserGeneralPanel general;
}
