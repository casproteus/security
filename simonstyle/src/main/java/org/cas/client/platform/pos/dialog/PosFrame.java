...
public class PosFrame extends JFrame implements ICASDialog, ActionListener, WindowListener, ComponentListener {

    public static PosFrame instance;

    public static void main(
            String[] args) {
        if (instance == null) {
            instance = new PosFrame();
        }
    ...
    public PosGeneralPanel general;
}
