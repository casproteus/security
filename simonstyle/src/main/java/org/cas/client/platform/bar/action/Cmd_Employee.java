...
public class Cmd_Employee implements SamActionListener {

	private static Cmd_Employee instance;
	private Cmd_Employee() {}
	public static Cmd_Employee getInstance() {
		if(instance == null)
			instance = new Cmd_Employee();
		return instance;
	}
