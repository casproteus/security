...
public class AboutDlg extends JDialog implements ActionListener {
    ...
    private void initComponents() {
        ...
        lblVersion = new JLabel(BadmintonDlgConst.Version);
        lblCopyRight = new JLabel(BadmintonDlgConst.CopyRight);
        lblGivento = new JLabel(BadmintonDlgConst.Givento);
        lblUserName = new JLabel(System.getProperty("user.name"));
        lblLicenceNumber = new JLabel(BadmintonDlgConst.LicenceNumber.concat(getSN()));
        separater = new PIMSeparator("");
        lblNotice1 = new JLabel(BadmintonDlgConst.Notice1);
        lblNotice2 = new JLabel(BadmintonDlgConst.Notice2);
        lblNotice3 = new JLabel(BadmintonDlgConst.Notice3);
        lblMail = new JLabel(BadmintonDlgConst.Mail);
        lblQQ = new JLabel(BadmintonDlgConst.QQ);
