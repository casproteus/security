...
public class AddCategoryDlg  extends JDialog implements ICASDialog, ActionListener, ComponentListener{
	...
	private class GeneralPanel  extends JPanel implements ComponentListener{
		...
		private void initConponent(){
			...
			lblType = new JLabel(CategoryDialogConstants.POSITION);
		...
		public void reLayout() {
			...
			lblType.setBounds(lblCategoryName.getX(), lblCategoryName.getY() + lblCategoryName.getHeight() + CustOpts.VER_GAP,
					lblCategoryName.getWidth(), CustOpts.BTN_HEIGHT);
			dspIndex.setBounds(tfdCategoryName.getX(), lblType.getY(),
					tfdCategoryName.getWidth(), CustOpts.BTN_HEIGHT);
