...
public class BadmintonGeneralPanel extends JPanel implements ComponentListener {

    public BadmintonGeneralPanel() {
        initConponent();
    }
    ...
    public static PlatPanel pOpenBox;
