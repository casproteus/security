...
public class BarDlgConst1 implements BarDlgConst{
    ...
    @Override
	public String Close() {return "Fermer";}
    @Override
    ...
    @Override
	public String AddTable() {return "AJOUTER";}
    @Override
    ...
    @Override
	public String VolumnDiscount() {return "<html><center>REMISE<br>FACTURE</center></html>";}
    @Override
    ...
    @Override
	public String Report() {return "RAPPORT";}
    @Override
    public String CheckOut(){return "DECONNEXION";}
    @Override
	public String CheckInOut() {return "CONNEXION/DECONNEXION";}
    
    @Override
	public String Menu() {return "Menu";}
    @Override
	public String Language1() {return "Langue1";}
    @Override
	public String Language2() {return "Langue2";}
    @Override
	public String Language3() {return "Langue3";}
    @Override
	public String DSPINDEX() {return "Idx";}
    @Override
	public String PRICE() {return "Prix";}

    @Override
	public String EXACT_AMOUNT() {return "<html><center>MONTANT<br>EXACTE</center></html>";}
    @Override
	public String CASH() {return "Au Comptant";}
    @Override
    ...
    @Override
	public String SPLIT_BILL() {return "<html><center>DIVISER<br>FACTURE</center></html>";}
    @Override
	public String Modify() {return "Modifier";}
    @Override
	public String BillInfo() {return "<html><center>FACTURE<br>PIED INFO</center></html>";}
    @Override
	public String BillFootInfo() {return "Info de Pied de Facture";}
    @Override
    ...
    @Override
	public String CANCEL_ALL() {return "<html><center>Annuler<br>Tous</center></html>";}
    @Override
	...
	public String MODIFY() {return "MODIFIER";}
    @Override
	public String DISC_VOLUMN() {return "REMISE VOLUMN";}
    ...
    @Override
	public String IsFastFoodMode() {return "Mode de counter";}
    @Override
    ...
    @Override
	public String ProdName() {return "Nom";}
    @Override
	public String Count() {return "QTY";}
    @Override
	public String Price() {return "Prix";}
    @Override
	public String Subtotal() {return "Sout";}
    @Override
    ...
    @Override
	public String Receive() {return "Recu";}
    @Override
    ...
    @Override
	public String RefundNotice() {return "Plaire importer combien combiner";}
    @Override
    ...
    @Override
    public String SaleReport() {return "Rapport Des Ventes";}
    @Override
	public String SaleRecs() {return "Facture Record";}
    @Override
	public String FROM() {return "De";}
    @Override
	public String TO() {return "A";}

    @Override
	public String Code() {return "Code:";}
    @Override
	public String PHOTO() {return "Ajouter Photo...";}
    @Override
    ...
    @Override
	public String NICKNAME() {return "Surnom";}
    @Override
	public String JOB() {return "Titre";}// job
    @Override
	public String RELATION() {return "Relation...";}
    @Override
	public String IS_LADY() {return "Est dame";}
    @Override
	public String PASSWORD() {return "Mot de passe";}
    @Override
	public String Anniversary1() {return "Anniversaire1";}
    @Override
	public String Anniversary2() {return "Anniversaire2";}
    @Override
	public String JOIN_TIME() {return "Joindre Temps";}
    @Override
	public String ADDRESS() {return "Addr de Maison";}
    @Override
	public String PHONE() {return "Phone de Maison";}
    @Override
	public String MOBILE() {return "Cell";}
    @Override
    ...
    @Override
	public String SSCN() {return "SSN";}
    @Override
	public String SALARY() {return "Salaire";}
    @Override
    ...
    @Override
	public String GENERAL() {return "CARTE DE EMPLOYEE";}
    @Override
	public String EmployeeInfo() {return "EMPLOYEES";}
    @Override
	public String JobTitle() {return "Titre";}
    @Override
	public String NickName() {return "Surnom";}
    @Override
	public String Cellphone() {return "Cell Phone";}
    @Override
	public String PhoneNum() {return "Home Phone";}
    @Override
	public String HomeAddress() {return "Addresse";}
    @Override
	public String MailAddress() {return "Email";}
    @Override
	public String Account() {return "Compte";}

    @Override
	public String CompName() {return "Organisation";}
    @Override
	public String CompAddress() {return "Addresse";}
    @Override
	public String CompTel() {return "Tell";}
    @Override
	public String CompFax() {return "Fax";}

    @Override
	public String QQ() {return "IMS";}
    @Override
	public String MainPage() {return "Web Page";}
    @Override
    ...
    @Override
	public String INSURANCE() {return "Assurance";}
    @Override
    ...
    @Override
	public String Add() {return "Ajouter";}

    @Override
	public String WorkRecs() {return "Journal de travail";}   
    @Override
	public String MoneyInBox() {return "Argent restant";}
    @Override
	public String Calculate() {return "Calculer";}
    @Override
	public String Profit() {return "Profit";}
    ...
    @Override
	public String AddNewUser() {return "Ajouter nouveau utilisateur";}
    @Override
	public String ModiFyUser() {return "Modifier Utilisateur";}
    @Override
    ...
    @Override
	public String BillPanelBK(){return "Fond de panneau de facture";}
    @Override
    ...
    @Override
	public String FunctionBtnBK(){return "Fond de bouton de fonction";}
    @Override
	...
	@Override
	public String WIDTH() {return "LARGEUR";}
	@Override
	public String COUPON() {return "COUPON";}
	@Override
	public String GIFTCARD() {return "CARTE DE CADEAU";}
	@Override
	public String activeCode() {return "Code atif:";}
	@Override
	...
	@Override
	public String CurrentBalanceMsg() {return "Le solde actuel du compte est:";}
	@Override
	public String History() {return "Histoire";}
	@Override
