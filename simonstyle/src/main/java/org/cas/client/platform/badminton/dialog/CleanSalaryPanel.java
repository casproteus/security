...
public class CleanSalaryPanel extends JTabbedPane implements ComponentListener, ActionListener {
    public CleanSalaryPanel() {
        // init-----------
        general = new JPanel();
        lblSeleEmployee = new JLabel(BadmintonDlgConst.SeleEmployee);
        ...
        general.add(ok);
        addTab(BadmintonDlgConst.Clean, general);
    ...
    public void actionPerformed(
        ...
        if (tSource == ok) {
            ...
            if (tEmployee == null) { // the first cell is null, means the table is empty.
                JOptionPane.showMessageDialog(this, BadmintonDlgConst.NoEmpSelected);
                return;
            }
