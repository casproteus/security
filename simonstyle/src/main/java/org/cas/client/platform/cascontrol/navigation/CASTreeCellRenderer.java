 ...
 * @author sam
 */
class CASTreeCellRenderer extends JLabel implements TreeCellRenderer {
    ...
    /**
     * Returns a new instance of PIMTreeCellRenderer. Alignment is set to left aligned. Icons and text color are
     * determined from the UIManager.
     */
    public CASTreeCellRenderer() {
     ...
     * hand, if <code>font</code> is non-null, and not a <code>FontUIResource</code>, the font becomes <code>font</code>
     * .
     */
    public void setFont(
            Font font) {
    ...
    public void paint(
        ...
        if (selected) {
            ...
            // 注释掉这一段仅为了使Render呈现透明效果，JDK的代码中忽略了透明的情况，所以为了透明的效果，替换了该类。
            // if(bColor != null) {
            // imageOffset = getLabelStart();
            // g.setColor(bColor);
            // if(getComponentOrientation().isLeftToRight())
