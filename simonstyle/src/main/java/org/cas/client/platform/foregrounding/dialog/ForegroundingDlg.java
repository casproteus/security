...
public class ForegroundingDlg extends JDialog implements ICASDialog, ActionListener, WindowListener, ComponentListener {
    /**
     ...
     *            弹出对话框的Frame
     */
    public ForegroundingDlg(Frame parent) {
        super(parent, false);
    ...
    private void initDialog() {
        ...
        // 初始化－－－－－－－－－－－－－－－－
        general = new ForegroundingGeneralPanel();
    ...
    private ForegroundingGeneralPanel general;
}
