...
public class PosUtility {
        ...
        try {
            ...
            if (tRowCount > 0) {
                ...
                for (int i = 0; i < tRowCount; i++) {
                    new MerchandiseDlg(PosFrame.instance, tIDAry[i], tCodeAry[i], tPriceAry[i], tMnemonicAry[i],
    ...
    public static int getProdCodeLen() {
        String tValue = (String) CustOpts.custOps.getValue(PosDlgConst.ProdCodeLength);
