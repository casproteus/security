            ...
            try {
                ...
                if (isCreatingNewDish()) {
                    StringBuilder sql = new StringBuilder(
                        ...
                        .append(String.valueOf(Math.round(tPrice * 100))).append(", ")
                    ...
                    sql = new StringBuilder("Select ID from product where code = '")
                        ...
                        .append(String.valueOf(Math.round(tPrice * 100))).append(" and MNEMONIC = '")
                    ...
                    StringBuilder sql = new StringBuilder("update product set code = '").append(tfdLanguages[0].getText())
	                    ...
	                    .append("', PRICE = ").append(String.valueOf(Math.round(tPrice * 100)))
