...
public class TimerDisplayRenderer extends DefaultPIMTableCellRenderer
{
    ...
    boolean isSelected, boolean hasFocus, int row, int column)
    {
        ...
        else
        {
            ...
            switch (index)
            {
                ...
                case 2:
                case 3:
                    setText (AppointmentConstant.TIME_DISPLAY_AS_ARRAY[index]);
                    break;
                default:
                    setText (AppointmentConstant.TIME_DISPLAY_AS_ARRAY[0]);
                    break;
            }
        }
        return this;
