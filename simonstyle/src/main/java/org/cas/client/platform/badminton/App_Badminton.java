...
import org.cas.client.platform.badminton.dialog.BadmintonDlg;
...
public class App_Badminton extends AbstractApp {
    /** Creates a new instance of TaskViewPane */
    public App_Badminton() {
        super(null);
        initActionFlags();
    }
    ...
    public Action getAction(
        ...
        if (actionFlags.get(prmActionName) != null) {// 看看该ActionName是否被系统维护.如果是系统有维护的,那么就是系统的Action.
            ...
            tmpClassPath.append("badminton.action.");// 系统自带的Action都在emo.pim.pimcontrol.commonaction目录下.
    ...
    public void showDialog(
            ...
            boolean prmDrag) {
        new BadmintonDlg(parent).setVisible(true);
    }

    public ICASDialog getADialog() {
        return new BadmintonDlg(null);
    }
    ...
    public IView getTiedView() {
        return BadmintonTiedView.getInstance();
    }

    public Icon getAppIcon(
            boolean prmIsBig) {
        if (prmIsBig)
            return PIMPool.pool.getIcon("/org/cas/client/platform/badminton/img/BadMinton32.gif");
        else
            return PIMPool.pool.getIcon("/org/cas/client/platform/badminton/img/BadMinton16.gif");
    }
