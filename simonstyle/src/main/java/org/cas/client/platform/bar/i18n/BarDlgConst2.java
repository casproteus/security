...
public class BarDlgConst2 implements BarDlgConst{
    ...
    @Override
	public String BillFootInfo() {return BillInfo();}
    @Override
	public String ChangePrice() {return "特价";}
    @Override
	public String CHANGEPRICE() {return ChangePrice();}
    @Override
    ...
    @Override
    public String ConvertVoidBillBack() {return "该账单已经被清空，您确定希望将其重新打开吗？";}
    @Override
    ...
    @Override
	public String IsTaxNotAllowDiscount() {return "打折时税款不应该受到影响";}
    @Override
    ...
    @Override
	public String AddNewModificationItem() {return "新建(样式：EN;FR;CN;IT, EN;FR;CN;IT)";}
    @Override
