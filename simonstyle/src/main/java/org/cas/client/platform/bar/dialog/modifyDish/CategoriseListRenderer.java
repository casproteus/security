...
public class CategoriseListRenderer extends JPanel implements ListCellRenderer, Serializable {

    public CategoriseListRenderer() {
...
//        setBorder((cellHasFocus) ? UIManager.getBorder("List.focusCellHighlightBorder") : noFocusBorder);
    	setBackground(AddModificationDialog.backgrounds[index%10]);
        return this;
    }
     ...
     */
    public static class UIResource extends CategoriseListRenderer implements javax.swing.plaf.UIResource {
    }
