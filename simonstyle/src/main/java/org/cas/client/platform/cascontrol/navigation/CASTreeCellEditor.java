...
/**
 * 覆盖了jdk5.0的DefaultTreeCellRenderer类仅为了使Render呈现透明效果，JDK的代码中忽略了透明的情况，所以为了透明的效果，替换了该类，并 在pait方法体内做了少量修改。
 * 然后发现必须替换DefaultTreeCellEditor类使PIMTreeCellRenderer类编译通过，故产生本类。目前没有代码改动，将来如果对本类有精简或优化 请无忘记加注释于此^-^。
 * 
 * @author sam
 */
class CASTreeCellEditor implements ActionListener, TreeCellEditor, TreeSelectionListener {
    /** Editor handling the editing. */
    protected TreeCellEditor realEditor;

    /** Renderer, used to get border and offsets from. */
    protected CASTreeCellRenderer renderer;

    /** Editing container, will contain the <code>editorComponent</code>. */
    protected Container editingContainer;

    /**
     * Component used in editing, obtained from the <code>editingContainer</code>.
     */
    transient protected Component editingComponent;

    /**
     * As of Java 2 platform v1.4 this field should no longer be used. If you wish to provide similar behavior you
     * should directly override <code>isCellEditable</code>.
     */
    ...
    /**
     * Font to paint with, <code>null</code> indicates font of renderer is to be used.
     */
    protected Font font;

    /**
     * Constructs a <code>PIMTreeCellEditor</code> object for a JTree using the specified renderer and a default editor.
     * (Use this constructor for normal editing.)
     *
     * @param tree
     *            a <code>JTree</code> object
     * @param renderer
     *            a <code>PIMTreeCellRenderer</code> object
     */
    public CASTreeCellEditor(JTree tree, CASTreeCellRenderer renderer) {
        this(tree, renderer, null);
    }

    /**
     * Constructs a <code>PIMTreeCellEditor</code> object for a <code>JTree</code> using the specified renderer and the
     * specified editor. (Use this constructor for specialized editing.)
     *
     * @param tree
     *            a <code>JTree</code> object
     * @param renderer
     ...
     */
    public CASTreeCellEditor(JTree tree, CASTreeCellRenderer renderer, TreeCellEditor editor) {
    ...
    /**
     * Sets the font to edit with. <code>null</code> indicates the renderers font should be used. This will NOT override
     * any font you have set in the editor the receiver was instantied with. If <code>null</code> for an editor was
    ...
    /**
     * If the <code>realEditor</code> returns true to this message, <code>prepareForEditing</code> is messaged and true
     * is returned.
     */
    ...
    /**
     * If the <code>realEditor</code> will allow editing to stop, the <code>realEditor</code> is removed and true is
    ...
    /**
     * Returns an array of all the <code>CellEditorListener</code>s added to this PIMTreeCellEditor with
    ...
    /**
     * Returns true if <code>event</code> is <code>null</code>, or it is a <code>MouseEvent</code> with a click count >
     * 2 and <code>inHitRegion</code> returns true.
     * 
     * @param event
     *            the event being studied
     */
    ...
    /**
     * Returns true if the passed in location is a valid mouse location to start editing from. This is implemented to
     * return false if <code>x</code> is <= the width of the icon and icon gap displayed by the renderer. In other words
     * this returns true if the user clicks over the text part displayed by the renderer, and false otherwise.
     * 
     * @param x
    ...
    /**
     * Invoked just before editing is to start. Will add the <code>editingComponent</code> to the
    ...
    /**
     * This is invoked if a <code>TreeCellEditor</code> is not supplied in the constructor. It returns a
    ...
    /**
     * Cleans up any state after editing has completed. Removes the <code>editingComponent</code> the
     * <code>editingContainer</code>.
     */
    ...
    /**
     * <code>TextField</code> used when no editor is supplied. This textfield locks into the border it is constructed
     * with. It also prefers its parents font over its font. And if the renderer is not <code>null</code> and no font
    ...
    public class DefaultTextField extends JTextField {
        ...
        /**
         * Constructs a <code>PIMTreeCellEditor.DefaultTextField</code> object.
         *
         * @param border
        ...
        /**
         * Overrides <code>JComponent.getBorder</code> to returns the current border.
         */
        ...
        /**
         * Overrides <code>JTextField.getPreferredSize</code> to return the preferred size based on current font, if
         * set, or else use renderer's font.
         * 
        ...
        public Dimension getPreferredSize() {
            ...
            if (renderer != null && CASTreeCellEditor.this.getFont() == null) {
    ...
    public class EditorContainer extends Container {
        ...
        /**
         * Overrides <code>Container.paint</code> to paint the node's icon and use the selection color for the
         * background.
         */
        public void paint(
                Graphics g) {
        ...
        /**
         * Lays out this <code>Container</code>. If editing, the editor will be placed at <code>offset</code> in the x
        ...
        /**
         * Returns the preferred size for the <code>Container</code>. This will be at least preferred size of the editor
         * plus <code>offset</code>.
         * 
         * @return a <code>Dimension</code> containing the preferred size for the <code>Container</code>; if
         *         <code>editingComponent</code> is <code>null</code> the <code>Dimension</code> returned is 0, 0
         */
        public Dimension getPreferredSize() {
            if (editingComponent != null) {
