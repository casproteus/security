...
public class BadmintonDlg extends JDialog implements ICASDialog, ActionListener, WindowListener, ComponentListener {
    /**
     ...
     *            弹出对话框的Frame
     */
    public BadmintonDlg(Frame parent) {
        super(parent, false);
    ...
    private void initDialog() {
        ...
        // 初始化－－－－－－－－－－－－－－－－
        general = new BadmintonGeneralPanel();
    ...
    private BadmintonGeneralPanel general;
}
