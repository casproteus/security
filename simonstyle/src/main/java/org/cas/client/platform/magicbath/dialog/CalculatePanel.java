...
public class CalculatePanel extends JTabbedPane implements ComponentListener, ActionListener {
    public CalculatePanel() {
        // init-----------
        general = new JPanel();
        lblSeleBoxNumber = new JLabel(MagicbathDlgConst.SeleBoxNumber);
        ...
        general.add(ok);
        addTab(MagicbathDlgConst.CustCalculate, general);
    ...
    public void actionPerformed(
        ...
        if (tSource == ok) {
            if (tblContent.getValueAt(0, 0) == null) { // the first cell is null, means the table is empty.
                JOptionPane.showMessageDialog(this, MagicbathDlgConst.NoUserSelected);
                return;
            }
            ...
            if (isRepeated(tBoxNumberSub))
                if (JOptionPane.showConfirmDialog(this, MagicbathDlgConst.ConfirmMsgOfRepeatedBoxNumber,
    ...
    private String[] initHeader() {
        ...
        try {
            ...
            header[0] = MagicbathDlgConst.BoxNumber;
            header[1] = MagicbathDlgConst.AddUp;
