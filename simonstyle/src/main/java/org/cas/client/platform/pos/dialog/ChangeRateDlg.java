...
public class ChangeRateDlg extends JDialog implements ICASDialog, ActionListener, ComponentListener, FocusListener {
    ...
    public void actionPerformed(
        ...
        if (o == ok) {// 更新新的汇率进入ini文件。
            CustOpts.custOps.setKeyAndValue(PosDlgConst.MoneyUnit[1], tfdLeft0.getText());
            CustOpts.custOps.setKeyAndValue(PosDlgConst.MoneyUnit[2], tfdLeft1.getText());
            CustOpts.custOps.setKeyAndValue(PosDlgConst.MoneyUnit[3], tfdLeft2.getText());
            CustOpts.custOps.setKeyAndValue(PosDlgConst.MoneyUnit[4], tfdLeft3.getText());
            CustOpts.custOps.setKeyAndValue(PosDlgConst.MoneyUnit[5], tfdLeft4.getText());
            CustOpts.custOps.setKeyAndValue(PosDlgConst.MoneyUnit[6], tfdLeft5.getText());
            CustOpts.custOps.setKeyAndValue(PosDlgConst.MoneyUnit[7], tfdLeft6.getText());
            CustOpts.custOps.setKeyAndValue(PosDlgConst.MoneyUnit[8], tfdLeft7.getText());
            dispose();
            setVisible(false);
        } else if (o == cancel) {
            dispose();
    ...
    private void initDialog() {
        setTitle(PosDlgConst.MRate);
        setResizable(false);
        setBounds((CustOpts.SCRWIDTH - 380) / 2, (CustOpts.SCRHEIGHT - 300) / 2, 380, 300); // 对话框的默认尺寸。

        // 初始化－－－－－－－－－－－－－－－－
        lblLeftUnit0 = new JLabel("1".concat(PosDlgConst.Unit).concat(" = "));
        lblLeftUnit1 = new JLabel("1".concat(PosDlgConst.Unit).concat(" = "));
        lblLeftUnit2 = new JLabel("1".concat(PosDlgConst.Unit).concat(" = "));
        lblLeftUnit3 = new JLabel("1".concat(PosDlgConst.Unit).concat(" = "));
        lblLeftUnit4 = new JLabel("1".concat(PosDlgConst.Unit).concat(" = "));
        lblLeftUnit5 = new JLabel("1".concat(PosDlgConst.Unit).concat(" = "));
        lblLeftUnit6 = new JLabel("1".concat(PosDlgConst.Unit).concat(" = "));
        lblLeftUnit7 = new JLabel("1".concat(PosDlgConst.Unit).concat(" = "));

        lblRightUnit0 = new JLabel(PosDlgConst.Unit);
        lblRightUnit1 = new JLabel(PosDlgConst.Unit);
        lblRightUnit2 = new JLabel(PosDlgConst.Unit);
        lblRightUnit3 = new JLabel(PosDlgConst.Unit);
        lblRightUnit4 = new JLabel(PosDlgConst.Unit);
        lblRightUnit5 = new JLabel(PosDlgConst.Unit);
        lblRightUnit6 = new JLabel(PosDlgConst.Unit);
        lblRightUnit7 = new JLabel(PosDlgConst.Unit);

        lblForeignLeft0 = new JLabel(PosDlgConst.MoneyUnit[1]);
        lblForeignLeft1 = new JLabel(PosDlgConst.MoneyUnit[2]);
        lblForeignLeft2 = new JLabel(PosDlgConst.MoneyUnit[3]);
        lblForeignLeft3 = new JLabel(PosDlgConst.MoneyUnit[4]);
        lblForeignLeft4 = new JLabel(PosDlgConst.MoneyUnit[5]);
        lblForeignLeft5 = new JLabel(PosDlgConst.MoneyUnit[6]);
        lblForeignLeft6 = new JLabel(PosDlgConst.MoneyUnit[7]);
        lblForeignLeft7 = new JLabel(PosDlgConst.MoneyUnit[8]);

        lblForeignRight0 = new JLabel("1".concat(PosDlgConst.MoneyUnit[1]).concat(" = "));
        lblForeignRight1 = new JLabel("1".concat(PosDlgConst.MoneyUnit[2]).concat(" = "));
        lblForeignRight2 = new JLabel("1".concat(PosDlgConst.MoneyUnit[3]).concat(" = "));
        lblForeignRight3 = new JLabel("1".concat(PosDlgConst.MoneyUnit[4]).concat(" = "));
        lblForeignRight4 = new JLabel("1".concat(PosDlgConst.MoneyUnit[5]).concat(" = "));
        lblForeignRight5 = new JLabel("1".concat(PosDlgConst.MoneyUnit[6]).concat(" = "));
        lblForeignRight6 = new JLabel("1".concat(PosDlgConst.MoneyUnit[7]).concat(" = "));
        lblForeignRight7 = new JLabel("1".concat(PosDlgConst.MoneyUnit[8]).concat(" = "));

        tfdLeft0 = new JTextField((String) CustOpts.custOps.getValue(PosDlgConst.MoneyUnit[1]));
        tfdLeft1 = new JTextField((String) CustOpts.custOps.getValue(PosDlgConst.MoneyUnit[2]));
        tfdLeft2 = new JTextField((String) CustOpts.custOps.getValue(PosDlgConst.MoneyUnit[3]));
        tfdLeft3 = new JTextField((String) CustOpts.custOps.getValue(PosDlgConst.MoneyUnit[4]));
        tfdLeft4 = new JTextField((String) CustOpts.custOps.getValue(PosDlgConst.MoneyUnit[5]));
        tfdLeft5 = new JTextField((String) CustOpts.custOps.getValue(PosDlgConst.MoneyUnit[6]));
        tfdLeft6 = new JTextField((String) CustOpts.custOps.getValue(PosDlgConst.MoneyUnit[7]));
        tfdLeft7 = new JTextField((String) CustOpts.custOps.getValue(PosDlgConst.MoneyUnit[8]));
