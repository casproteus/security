...
public class Dlg_ModifyData extends JDialog implements ActionListener, ComponentListener {
    ...
    private void initComponents() {
        ...
        // Build---------------------
        tabPane.addTab(MagicbathDlgConst.ADDDATA, addPanel);
        tabPane.addTab(MagicbathDlgConst.DELDATA, deletPanel);
        tabPane.addTab(MagicbathDlgConst.MODDATA, modifyPanel);
